...
BEGIN
	...
	INSERT INTO `projetogestordesenhas`.`log_conta` 
    VALUES 
    (parameter_nome, parameter_email, parameter_senha, parameter_url, parameter_tipoconta, parameter_fk_usuario, default);
