...
<head>
  ...
  <title>Perfil - <?PHP echo $nome_sessao; ?></title>
      ...
      <div id="content" style="background-color: white;">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800"><span style="font-size: 25pt;"><strong> Perfil - <?PHP echo $nome_sessao; ?></strong></span></h1>
          </div>
            ...
            <table class="table">
              <thead class="thead-blue">
                <tr id="colCabecalho">
                  ...
                  <th scope="col">Total de contas cadastradas</th>
              ...
              <tbody>
                ...
                <?php foreach ($InformacoesUsuario as $item) {  ?>
                  <tr>
                    <td> <?PHP echo $item['nomeUsuario'] ?> </td>
                    <td> <?PHP echo $item['email'] ?> </td>
                    <td> <?PHP echo count($InformacoesContas) ?> </td>
